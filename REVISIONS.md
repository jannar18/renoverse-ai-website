...
2. **`AGENTS.md`** — house rules pasted into Claude's context: token system, "match X" rule, halftone shader spec, component contract, breakpoint set. (Note: this file overlaps with what `CLAUDE.md` already does — decide whether to merge or split for the non-engineer audience.)
